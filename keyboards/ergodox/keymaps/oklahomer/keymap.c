...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        // right hand
             ...
             KC_NO,          KC_N,            KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                              KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_GRV,
             KC_NO,          KC_NO,
             KC_NO,
             KC_NO,          MO(SYMB), KC_SPACE
    ),
 ...
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        | VolDn| VolUp| Mute |      |      |------|           |------|MsLeft|MsDown| MsUp |MsRght|      |  Play  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |      |      |      | Prev | Next |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      | Lclk | Rclk |                                       |      |      |      |      |      |
...
[MDIA] = KEYMAP(
    ...
    // right hand
       KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO,
       KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO,
                KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NO, KC_MPLY,
